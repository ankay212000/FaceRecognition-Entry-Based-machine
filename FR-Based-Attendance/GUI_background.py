...
image = Image.open("./Backgrounds/geometric-uhd-8k-wallpaper.jpg")
...
head = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System",bg="green3", fg="white", width=50,
                   height=1, font=( 'Comic Sans MS',30,'italic'))
head.place(x=125, y=20)
admin = tk.Button(window, text="Admin Login", command=password, fg="white", bg="blue", width=70, height=3,
                     activebackground="Red", font=('Helvetica', 15, ' bold '))
admin.place(x=250, y=200)                   
attendance_button= tk.Button(window, text="Attendance", command=create_window2, fg="white", bg="blue", width=70, height=3,
                     activebackground="Red", font=('Helvetica', 15, ' bold '))
attendance_button.place(x=250, y=380)
Quit_button=tk.Button(window,text="Quit",command=window.destroy,fg="white",bg="purple3", width=70, height=3,
                    activebackground="Red", font=('times',15,'bold'))
Quit_button.place(x=250,y=570)
